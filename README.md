...
cp public/images/* client/public/images/
cp public/favicon_new.png client/public/
```
...
- **Booked dates:** `AvailabilityCalendar.jsx` → `BOOKED_DAYS` Set
- **Social links:** `Footer.jsx` → social icon hrefs
- **Maps link:** `ContactPage.jsx` → "Get Directions" href
